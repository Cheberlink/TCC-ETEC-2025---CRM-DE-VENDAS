    ...
    <>
     <Header type={1}></Header>
      ...
      <main className="flex justify-center space-x-8 py-12">
        {/* Básico */}
        <div className="bg-gray-400 w-64 h-72 p-6 flex flex-col justify-between rounded-md">
        ...
        {/* Avançado */}
        <div className="bg-red-900 w-64 h-72 p-6 flex flex-col justify-between rounded-md text-white">
        ...
        {/* Empresarial */}
        <div className="bg-black w-64 h-72 p-6 flex flex-col justify-between rounded-md text-white">
